...
/*
 * Broadcom STB Configuration
 */
#define CONFIG_USER_BRCM_PM 1
#undef  CONFIG_USER_MOCA_NONE
#undef  CONFIG_USER_MOCA_MOCA1
#define CONFIG_USER_MOCA_MOCA2 1
#define CONFIG_LIB_LIBGCC 1
#undef  CONFIG_USER_MOCA_GEN1
#undef  CONFIG_USER_MOCA_GEN2
#define CONFIG_USER_MOCA_GEN3 1
 ...
 */
#undef  CONFIG_LIB_DIRECTFB_FORCE
#undef  CONFIG_LIB_FREETYPE_FORCE
#undef  CONFIG_LIB_LIBCAP_FORCE
...
#undef  CONFIG_LIB_LIBUSB_FORCE
#define CONFIG_LIB_LIBSTDCXX_FORCE 1
#define CONFIG_LIB_LIBGCC_FORCE 1
#undef  CONFIG_LIB_LIBSSP_FORCE

/*
 * C library configuration
 */
#undef  CONFIG_LIB_LIBC_FROM_ROOTFS
#undef  CONFIG_LIB_LIBC_LDD
#undef  CONFIG_LIB_LIBC_LDCONFIG
...
#undef  CONFIG_USER_MTDUTILS_FLASH_INFO
#define CONFIG_USER_MTDUTILS_NANDDUMP 1
#define CONFIG_USER_MTDUTILS_NANDTEST 1
#define CONFIG_USER_MTDUTILS_NANDWRITE 1
#define CONFIG_USER_MTDUTILS_MTD_DEBUG 1
#undef  CONFIG_USER_MTDUTILS_SUMTOOL
#define CONFIG_USER_MTDUTILS_UBI_UTILS 1
...
#define CONFIG_USER_GPTFDISK_GDISK 1
#define CONFIG_USER_GPTFDISK_SGDISK 1
#define CONFIG_LIB_LIBSTDCXX 1
#define CONFIG_LIB_POPT 1
#define CONFIG_LIB_LIBGCC 1
#define CONFIG_USER_E2FSPROGS_MISC_LIBUUID 1
...
#undef  CONFIG_USER_E2FSPROGS_RESIZE_RESIZE2FS
#undef  CONFIG_USER_E2FSPROGS_MISC_UUIDGEN
#undef  CONFIG_USER_E2FSPROGS_DEBUGFS_DEBUGFS
...
#undef  CONFIG_USER_SQUASHFS_UNSQUASHFS

/*
 * XFS
 */
#undef  CONFIG_USER_XFS_XFSPROGS
#undef  CONFIG_USER_XFS_TEST_SUITE

/*
 * NTFS
 */
#undef  CONFIG_USER_NTFS_3G
...
#undef  CONFIG_USER_DHCP_ISC_CLIENT_DHCP
#undef  CONFIG_USER_DHCPCV6_DHCPCV6
#undef  CONFIG_USER_DHCPSV6_DHCPSV6
#undef  CONFIG_USER_DIALD_DIALD
#undef  CONFIG_USER_DISCARD_DISCARD
#undef  CONFIG_USER_DMALLOC_DMALLOC
#undef  CONFIG_USER_DNSMASQ_DNSMASQ
#undef  CONFIG_USER_ETHATTACH_ETHATTACH
#undef  CONFIG_USER_EPI_TTCP
#define CONFIG_USER_ETHTOOL 1
#undef  CONFIG_USER_ETHTOOL_PRETTY_DUMP
...
#undef  CONFIG_USER_IPTRAF_IPTRAF
...
#undef  CONFIG_USER_TTCP_TTCP
#undef  CONFIG_USER_UCDSNMP_SNMPD
#undef  CONFIG_USER_UTELNETD
...
#undef  CONFIG_USER_AFFINITY
#undef  CONFIG_USER_BONNIEXX_BONNIEXX
#undef  CONFIG_USER_CAL_CAL
#undef  CONFIG_USER_CHAT_AFFINITY
#undef  CONFIG_USER_CHAT_CHAT
#undef  CONFIG_USER_CKSUM_CKSUM
#undef  CONFIG_USER_CLOCK_CLOCK
#define CONFIG_USER_CMATOOL 1
 ...
 * I2C-Tools
 */
#define CONFIG_USER_I2C_TOOLS 1
...
#define CONFIG_USER_PROCPS_PS 1
...
#define CONFIG_USER_PROCPS_VMSTAT 1
...
#define CONFIG_USER_PCIUTILS_SETPCI 1

/*
 * MMC utilities
 */
#define CONFIG_USER_MMCUTILS 1
...
#undef  CONFIG_USER_PROFILE_OPROFILE
#undef  CONFIG_USER_LTT_CONTROL
#undef  CONFIG_USER_PERF
#undef  CONFIG_USER_TRACECMD
#define CONFIG_USER_TMON 1
#define CONFIG_LIB_NCURSES 1
